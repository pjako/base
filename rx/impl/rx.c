...
#define RX__GL_FUNCS \
    ...
    RX__XMACRO(glGetUniformBlockIndex,            GLuint, (GLuint program, const GLchar *uniformBlockName)) \
...
LOCAL GLenum rx_glInternalTextureFormat(rx_textureFormat imgFormat) {
    switch (imgFormat) {
        ...
        //case rx_textureFormat_r16unorm:                    return GL_R16;
        //case rx_textureFormat_r16snorm:                    return GL_R16_SNORM;
#endif
...
#if !defined(RX_GLES3) && OS_APPLE == 0
        //case rx_textureFormat_168unorm:
